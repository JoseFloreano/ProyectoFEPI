...
export const DatabaseProvider = ({ children }) => {
  ...
  // Estado para ejercicios completados (guardados en localStorage)
  ...
  const completeExercise = (exerciseId) => {
    ...
    localStorage.setItem('c-practice-completed', JSON.stringify([...newCompleted]));
  };
  ...
  const isProjectCompleted = (projectId) => {
    ...
    return project.exercises.every(ex => completedExercises.has(ex.id));
  };
